        ...
        <div class="panel panel-primary animated flipInY">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">
                   <i class="fa fa-key"></i> #$r( "resetpassword@security" )#
                </h3>
            </div>
            ...
            <div class="panel-body">
				...
				#getModel( "messagebox@cbMessagebox" ).renderit()#
  				...
  				<p>#$r( "resetpassword.instructions@security" )#</p>
				...
				#html.startForm(
					...
					<div id="passwordRules" class="well well-sm" data-min-length="#prc.cbSettings.cb_security_min_password_length#">
						...
						<p class="help-block">#$r( "common.passwordrules@security" )#</p>
					</div>

					<div class="form-group">

						<div class="col-md-12">
							<label for="password_confirmation">#$r( "resetpassword.confirm@security" )#</label>
						</div>
