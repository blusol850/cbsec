...
component accessors="true" threadSafe singleton{
	...
	*/
	cbsec.models.security.twofactor.ITwoFactorProvider function getDefaultProviderObject(){
	...
	*/
	TwoFactorService function registerProvider( required cbsec.models.security.twofactor.ITwoFactorProvider provider ){
	...
	*/
	cbsec.models.security.twofactor.ITwoFactorProvider function getProvider( required name ){
